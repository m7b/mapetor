...
function(_Boost_COMPONENT_DEPENDENCIES component _ret)
  ...
  elseif(NOT Boost_VERSION VERSION_LESS 106200 AND Boost_VERSION VERSION_LESS 106800)
    ...
    set(_Boost_WAVE_DEPENDENCIES filesystem system serialization thread chrono date_time atomic)
    set(_Boost_WSERIALIZATION_DEPENDENCIES serialization)
  elseif(NOT Boost_VERSION VERSION_LESS 106800 AND Boost_VERSION VERSION_LESS 107000)
    set(_Boost_CONTEXT_DEPENDENCIES thread chrono date_time)
    set(_Boost_COROUTINE_DEPENDENCIES context)
    set(_Boost_COROUTINE2_DEPENDENCIES context fiber thread chrono date_time)
    set(_Boost_FIBER_DEPENDENCIES context thread chrono date_time)
    set(_Boost_IOSTREAMS_DEPENDENCIES regex)
    ...
    set(_Boost_WSERIALIZATION_DEPENDENCIES serialization)
  elseif(NOT Boost_VERSION VERSION_LESS 106900 AND Boost_VERSION VERSION_LESS 107100)
    set(_Boost_CONTEXT_DEPENDENCIES thread chrono date_time)
    set(_Boost_COROUTINE_DEPENDENCIES context)
    set(_Boost_COROUTINE2_DEPENDENCIES context fiber thread chrono date_time)
    set(_Boost_FIBER_DEPENDENCIES context thread chrono date_time)
...
foreach(COMPONENT ${Boost_FIND_COMPONENTS})
  ...
  FOREACH(suf ${CMAKE_FIND_LIBRARY_SUFFIXES})
	  foreach(compiler IN LISTS _boost_COMPILER)
		list(APPEND _boost_RELEASE_NAMES
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf} )
	  endforeach()
	  list(APPEND _boost_RELEASE_NAMES
		${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
		${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf}
  ...
  if(_boost_STATIC_RUNTIME_WORKAROUND)
	...
	FOREACH(suf ${CMAKE_FIND_LIBRARY_SUFFIXES})
		foreach(compiler IN LISTS _boost_COMPILER)
		  list(APPEND _boost_RELEASE_NAMES
			${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
			${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf} )
		endforeach()
		list(APPEND _boost_RELEASE_NAMES
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf} )
    ENDFOREACH(suf)
  endif()
  ...
  FOREACH(suf ${CMAKE_FIND_LIBRARY_SUFFIXES})
	  foreach(compiler IN LISTS _boost_COMPILER)
		list(APPEND _boost_DEBUG_NAMES
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf} )
	  endforeach()
	  list(APPEND _boost_DEBUG_NAMES
		${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
		${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf}
  ...
  FOREACH(suf ${CMAKE_FIND_LIBRARY_SUFFIXES})
		...
		foreach(compiler IN LISTS _boost_COMPILER)
		  list(APPEND _boost_DEBUG_NAMES
			${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
			${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf} )
		endforeach()
		list(APPEND _boost_DEBUG_NAMES
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}-${Boost_LIB_VERSION}${suf}
		  ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${Boost_Architecture_and_address_model_tag}${suf} )
  ENDFOREACH(suf) 
  endif()
  if(Boost_THREADAPI AND ${COMPONENT} STREQUAL "thread")
